# Archived ML architecture

This document describes the retired model-training and sandbox-crawler system. It is preserved as historical design documentation, not current setup instructions. See README.md and CURATION.md for the active agent-curated workflow.
